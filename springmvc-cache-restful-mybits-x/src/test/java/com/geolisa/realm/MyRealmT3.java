...
public class MyRealmT3 implements Realm {

    private static final Logger LOG = LoggerFactory.getLogger(MyRealmT3.class);
    ...
    public AuthenticationInfo getAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        StringBuffer usernameBuffer = new StringBuffer(principal);
        usernameBuffer.append("@163.com");
        return new SimpleAuthenticationInfo(usernameBuffer.toString(), credentials, getName());
    }
}
